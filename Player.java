...
public class Player{
	...
	public void updatetotalCashInHand(double totalCashInHand){//Polymorphism,signature must same :public void updatetotalCashInHand(double totalCashInHand)
	...
	public String toString(){
		...
		return "Player name "+name+" with token "
		+selectedToken+" has RM"+totalCashInHand;
	}
